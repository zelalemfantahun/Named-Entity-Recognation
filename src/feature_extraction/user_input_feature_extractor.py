...
for x in train_token:
    ...
    for i in (range(len(train_token))):
        ...
        if current_word in product_list:
            ...
            final_word_found = ('word=' + cur_word + '\t' + 'cur_pos=' + current_pos + '\t' + 'next_word=' + str(
            ...
            final_word_notfound = ('word=' + curword + '\t' + 'cur_pos=' + current_pos + '\t' + 'next_word=' + str(
                next_word) + '\t' + 'next_pos=' + next_pos + '\t' + 'prev_word=' + previous_word + '\t' + 'prev_pos=' + previous_pos + '\t' + 'next_two=' + str(
                next_two) + '\t' + 'prev_two=' + str(previous_two))
        ...
        if product_list.__contains__ (bigrams_words):
            ...
            bigram_final = ('word=' + bigram + '\t' +'cur_pos='+'NP'+'\t' +'next_word=' + str(next_word) + '\t' + 'next_pos=' + next_pos + '\t' + 'prev_word=' + previous_word + '\t' + 'prev_pos=' + previous_pos + '\t' + 'next_two=' + str(
                next_two) + '\t' + 'prev_two=' + str(previous_two))
        ...
        try:
            ...
            if product_list.__contains__(trigram_words):
                ...
                trigram_final = ('word=' + trigram + '\t' + 'cur_pos=' + 'NP' + '\t' + 'next_word=' + str(
                    next_word) + '\t' + 'next_pos=' + next_pos + '\t' + 'prev_word=' + previous_word + '\t' + 'prev_pos=' + previous_pos + '\t' + 'next_two=' + str(
                    next_two) + '\t' + 'prev_two=' + str(previous_two))
        ...
        try:
            ...
            if product_list.__contains__(quadragrams_words):
                ...
                quadragrams_final = ('word=' + quadragrams + '\t' + 'cur_pos=' + 'NP' + '\t' + 'next_word=' + str(
                    next_word) + '\t' + 'next_pos=' + next_pos + '\t' + 'prev_word=' + previous_word + '\t' + 'prev_pos=' + previous_pos + '\t' + 'next_two=' + str(
                    next_two) + '\t' + 'prev_two=' + str(previous_two))
